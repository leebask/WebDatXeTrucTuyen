...
function Cars({ imgSrc, maXe, bienSo, loaiXe, soLuongGhe, gia, tour, DataTicket, setReloadData, reloadData }) {
    ...
    const addMaGhe = (e) => {
        ...
        if (
            ...
            setlayMaGhe([...layMaGhe, e.target.id]);
        } else {
            toast.warn('Ghế đã được đặt! Mời chọn ghế khác.');
        }
        console.log([...layMaGhe, e.target.id]);
    };
    // useEffect(() => {
    //   addMaGhe()
    // },[])
    ...
    const PostTicket = () => {
        console.log({
            maVe:
                DataTicket.reduce(function (accumulator, element) {
                        ...
                        <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                            <Box sx={{ width: '100%' }}>
                                ...
                                <div>
                                    {allStepsCompleted() ? (
                                        <React.Fragment>
                                            <Typography sx={{ mt: 2, mb: 1 }}>Xác nhận đặt vé!</Typography>
                                                ...
                                                <>
                                                    <FormControl>
                                                        ...
                                                        <RadioGroup
                                                            ...
                                                            {tour.noiDi == 'SaiGon' ? (
                                                                <FormControlLabel
                                                                    onClick={(e) => setChonDiaDiem(e.target.value)}
                                                                    ...
                                                                    label={
                                                                        <>
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                <LocationOnIcon />
                                                                                số 292 đường Đinh Bộ Lĩnh, Phường 26,
                                                                    ...
                                                                    label={
                                                                        <>
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                <LocationOnIcon />
                                                                                Km 4, Đường Nguyễn Chí Thanh, Phường Tân
                                                                                An, Buôn Ma Thuột, Đắk Lắk
                                                                            </span>
                                                                        </>
                                                                    }
                                                                />
                                                            ...
                                                            <FormControlLabel
                                                                onClick={(e) => setChonDiaDiem(e.target.value)}
                                                                value="Nhà xe liên hệ để đón"
                                                                control={<Radio />}
                                                                label={
                                                                    <>
                                                                        <div style={{ fontSize: 'large' }}>
                                                                            Nhà xe liên hệ để đón
                                                                        </div>
                                                                        <span
                                                                            style={{ fontSize: 'small', opacity: 0.8 }}>
                                                                            <LocationOnIcon />
