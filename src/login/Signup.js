...
function SignUp() {
    ...
    const signUp = (e) => {
        e.preventDefault();
        if (!fName) {
            return toast.info('Vui lòng nhập tên');
        }
        if (!lName) {
            return toast.info('Vui lòng nhập họ');
        }
        ...
        <div className="signup">
            ...
            <div className="signup__info">
                ...
                <form className="signup__form">
                    ...
                    <input id="email" type="text" value={fName} onChange={(e) => setFName(e.target.value)} />
                    <label htmlFor="lName">Họ</label>
                    <input id="email" type="text" value={lName} onChange={(e) => setLName(e.target.value)} />
