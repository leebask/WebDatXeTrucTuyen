...
function Car() {
    ...
    return (
        <div className="admin_car" style={{ padding: '36px 10px 10px 10px', width: '100%' }}>
            ...
            />
            <Modal title="Thêm mới xe" visible={isModalVisibleThem} onOk={handleOkThem} onCancel={handleCancelThem}>
            ...
            {/* sửa */}
            <Modal title="Sửa thông tin xe" visible={isModalVisibleSua} onOk={handleOkSua} onCancel={handleCancelSua}>
                <div style={{ display: 'flex', flexDirection: 'row' }}>
                    <div style={{ width: '40%' }}>
                        <p>Biển số:</p>
                        <p>Loại xe:</p>
