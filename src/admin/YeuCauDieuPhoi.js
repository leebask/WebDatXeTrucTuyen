...
function YeuCauDieuPhoi() {
    ...
    const columns = [
...

        {
            ...
            render: (data, record) => {
                return (
                    <div style={{ textAlign: 'center', border: '1px solid #79aded' }}>
                        {data == 1 ? (
                            <div style={{ color: 'green' }}>Chưa điều phối</div>
                        ) : (
    ...
    return (
        <div className="admin_dieuphoi" style={{ padding: '36px 10px 10px 10px', width: '100%' }}>
            <div className="admin_tour_header">
                ...
                <Button type="primary" ghost onClick={ConFirmDieuPhoi}>
                    Xác nhận điều phối
                </Button>
                <Button danger onClick={DeleteDieuPhoi}>
                    Hủy điều phối
                </Button>
